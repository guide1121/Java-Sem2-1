...
public class MovieTester {
	...
	public static void main(String[] args)
	{
		...
		//Challenge
		List<Movie> genreMovies = catalog.searchByGenre("Animation");
		System.out.println("Movies whose genre are Animtaion \n\t"+genreMovies.toString().replaceAll(" Movie", "\n\tMovie"));
		
		List<Movie> genreScoreMovies = catalog.searchByGenreAndScore("Romance", 60, 100);
		System.out.println("Movies whose genre are Romance and scores between \"90%-100%\" \n\t"+genreScoreMovies.toString().replaceAll(" Movie", "\n\tMovie"));
		...
		MovieCatalog.saveMoviesJSON(genreMovies, "searchresults-genre-animation.json");
		MovieCatalog.saveMoviesJSON(genreScoreMovies, "searchresults-genre-romance-60-100.json");
