...
public class BankTester {
	...
	public static void main(String[] args) {
        ...
        System.out.println(bangkokbank.find(2810).getBalance()); //ดึงข้อมูลบัญชีมาทั้งบัญชีและเข้าถึงยอดเงินด้วย getBalance
        System.out.println(bangkokbank.getMax().getAccountNumber()); //ดึงข้อมูลบัญชีที่มีเงินมากที่สุดมาทั้งบัญชีและเข้าถึงยอดเงินด้วย getAccountNumber
        System.out.println(bangkokbank.getMin().getAccountNumber()); //ดึงข้อมูลบัญชีที่มีเงินน้อยที่สุดมาทั้งบัญชีและเข้าถึงยอดเงินด้วย getAccountNumber
